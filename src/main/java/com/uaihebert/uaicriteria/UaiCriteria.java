...
public interface UaiCriteria<T> {
    ...
    public UaiCriteria<T> orGreaterThan(final String attributeName, final Object value);

    public UaiCriteria<T> orGreaterThan(final boolean toLowerCase, final String attributeName, final String value);

    public UaiCriteria<T> orGreaterThan(final int index, final String attributeName, final Object value);

    public UaiCriteria<T> orGreaterThan(final boolean toLowerCase, final int index, final String attributeName, final String value);
    ...
    public UaiCriteria<T> orGreaterOrEqualTo(final String attributeName, final Object value);

    public UaiCriteria<T> orGreaterOrEqualTo(final boolean toLowerCase, final String attributeName, final String value);

    public UaiCriteria<T> orGreaterOrEqualTo(final int index, final String attributeName, final Object value);

    public UaiCriteria<T> orGreaterOrEqualTo(final boolean toLowerCase, final int index, final String attributeName, final String value);
    ...
    public UaiCriteria<T> orLessThan(final String attributeName, final Object value);

    public UaiCriteria<T> orLessThan(final boolean toLowerCase, final String attributeName, final String value);

    public UaiCriteria<T> orLessThan(final int index, final String attributeName, final Object value);

    public UaiCriteria<T> orLessThan(final boolean toLowerCase, final int index, final String attributeName, final String value);
    ...
    public UaiCriteria<T> orLessOrEqualTo(final String attributeName, final Object value);

    public UaiCriteria<T> orLessOrEqualTo(final boolean toLowerCase, final String attributeName, final String value);

    public UaiCriteria<T> orLessOrEqualTo(final int index, final String attributeName, final Object value);

    public UaiCriteria<T> orLessOrEqualTo(final boolean toLowerCase, final int index, final String attributeName, final String value);
