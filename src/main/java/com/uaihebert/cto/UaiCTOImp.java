...
public final class UaiCTOImp<T> implements UaiCriteria<T> {
    ...
    public UaiCriteria<T> orGreaterThan(int index, String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_GREATER_THAN, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orGreaterThan(boolean toLowerCase, int index, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, toLowerCase, attributeName, CriteriaConditionType.OR_GREATER_THAN, value));
        return this;
    }
    ...
    public UaiCriteria<T> orGreaterOrEqualTo(String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(attributeName, CriteriaConditionType.OR_GREATER_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orGreaterOrEqualTo(int index, String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_GREATER_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orGreaterOrEqualTo(boolean toLowerCase, int index, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, toLowerCase, attributeName, CriteriaConditionType.OR_GREATER_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orGreaterOrEqualTo(boolean toLowerCase, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(toLowerCase, attributeName, CriteriaConditionType.OR_GREATER_OR_EQUAL_TO, value));
        return this;
    }
    ...
    public UaiCriteria<T> orLessThan(String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(attributeName, CriteriaConditionType.OR_LESS_THAN, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessThan(int index, String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_LESS_THAN, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessThan(boolean toLowerCase, int index, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, toLowerCase, attributeName, CriteriaConditionType.OR_LESS_THAN, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessThan(boolean toLowerCase, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(toLowerCase, attributeName, CriteriaConditionType.OR_LESS_THAN, value));
        return this;
    }
    ...
    public UaiCriteria<T> orLessOrEqualTo(String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(attributeName, CriteriaConditionType.OR_LESS_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessOrEqualTo(int index, String attributeName, Object value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_LESS_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessOrEqualTo(boolean toLowerCase, int index, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, toLowerCase, attributeName, CriteriaConditionType.OR_LESS_OR_EQUAL_TO, value));
        return this;
    }

    @Override
    public UaiCriteria<T> orLessOrEqualTo(boolean toLowerCase, String attributeName, String value) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(toLowerCase, attributeName, CriteriaConditionType.OR_LESS_OR_EQUAL_TO, value));
        return this;
    }
    ...
    public <E> UaiCriteria<T> orAttributeIn(String attributeName, List<E> attributeList) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(attributeName, CriteriaConditionType.OR_ATTRIBUTE_IN, attributeList.toArray()));
        return this;
    }
    ...
    public <E> UaiCriteria<T> orAttributeIn(int index, String attributeName, List<E> attributeList) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_ATTRIBUTE_IN, attributeList));
        return this;
    }
    ...
    public <E> UaiCriteria<T> orAttributeNotIn(String attributeName, List<E> attributeList) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(attributeName, CriteriaConditionType.OR_ATTRIBUTE_NOT_IN, attributeList.toArray()));
        return this;
    }

    @Override
    public <E> UaiCriteria<T> orAttributeNotIn(int index, String attributeName, List<E> attributeList) {
        criteriaConditionTypeList.add(new CriteriaConditionHolder(index, DO_NOT_APPLY_LOWER_CASE, attributeName, CriteriaConditionType.OR_ATTRIBUTE_NOT_IN, attributeList));
        return this;
    }
